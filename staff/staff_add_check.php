...
<body class="staff-page">
    ...
    if($_POST['password2'] == '') {
        echo '<p class="error">確認用パスワードが入力されていません</p>';
    }
    ...
    if($_POST['password'] !== $_POST['password2']) {
        echo '<p class="error">パスワ－ドが一致しませんでした</p>';
    }

    if($_POST['name'] == '' || $_POST['password'] == '' || $_POST['password2'] == '' || $_POST['password'] !== $_POST['password2']) {
